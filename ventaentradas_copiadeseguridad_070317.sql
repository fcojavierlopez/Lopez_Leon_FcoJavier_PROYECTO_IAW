...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2017 a las 08:42:36
...
(25, 'Berto Romero', 'MonÃ³logo.', 'Alberto Romero TomÃ¡s (Cardona, Barcelona, 17 de noviembre de 1974), mÃ¡s conocido como Berto Romero, es un humorista, guionista y actor espaÃ±ol. ParticipÃ³ en los programas de humor Buenafuente (La Sexta), Buenas noches y Buenafuente (Antena 3) y En el aire (La Sexta) y fue columnista del diario PÃºblico. Actualmente presenta junto a Andreu Buenafuente el programa de radio de la Cadena SER Nadie Sabe Nada, donde improvisan temas propuestos por el pÃºblico y tambiÃ©n participa como colaborador en el programa Late Motiv presentado por Andreu Buenafuente en Movistar+ #0, su secciÃ³n trata de un consultorio en el que responde las preguntas de la gente.', 'roberto_monologo.jpg', 'http://bertoromero.com/'),
(26, 'Hardwell', 'Electro House', 'El joven neerlandÃ©s Hardwel es ya un reconocido artista, creador de un estilo de mÃºsica propio.\r\nCon siete aÃ±os era ya aficionado a la mÃºsica y los catorce un prestigioso disc jockey y a los diecisÃ©is tenÃ­a ya cuatro discos publicados, siendo Ã©l su propio productor.\r\nConocido por los grandes Ã©xitos cosechados en mÃºsica house progresivo y electro house.\r\nUn genio que consigue con sus mezclas musicales, despertar pasiÃ³n y emociones frenÃ©ticas allÃ¡ donde va. AnimaciÃ³n y energÃ­a que te impulsan a no parar de bailar.', 'hardwell.jpg', 'https://www.djhardwell.com/'),
(27, 'Axwell', 'House', 'Axwell (Axel Hedfors), nacido en una de las mÃ¡s singulares y caracterÃ­sticas zonas rurales de Suecia, -sintiÃ³- el envite musical desde una edad muy temprana. A los 9 aÃ±os, descubrÃ­a la magia de la percusiÃ³n, aunque no fuÃ© hasta los 13, cuando se puso delante de un ordenador y pudo -jugar- con todos los sonidos e instrumentos que comenzÃ³ a verse completamente identificado con aquÃ©l, para Ã©l, mÃ¡gico mundo.', 'axwell.jpg', '-');
...
('fcojavierlopezleon@gmail.com', 1, NULL),
...
(28, 'El SueÃ±o De Una Noche De Cabaret', 'musical', 11.25, 'https://www.elcorteingles.es/entradas/teatros-y-musicales/entradas-el-sueno-de-una-noche-de-cabaret-sevilla-0000085Qd0000085QA000008593', '2017-04-21', '2017-04-21', 4),
...
(23, 'Ciudad Real', 'Ciudad Real', 'EspaÃ±a', 0.0000000000, 0.0000000000);
...
('usuario7@gmail.com', '400e70d06ac952d601f3c690f005628e', '2017-01-26', 22, 'LÃ“PEZ RODRIGUEZ', 'ELIZABETH', 0),
